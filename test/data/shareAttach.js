// fca-azadx69x - Share Attachment Test Fixture
// Used for testing share attachment parsing functionality

console.log('fca-azadx69x', 'Loading share attachment fixture...');
...
console.log('fca-azadx69x', 'Share attachment fixture loaded successfully');
console.log('fca-azadx69x', 'Share title:', module.exports.delta.attachments[0].mercury.share.title);
console.log('fca-azadx69x', 'Call to actions count:', module.exports.delta.attachments[0].mercury.share.target.items[0].call_to_actions.length);
